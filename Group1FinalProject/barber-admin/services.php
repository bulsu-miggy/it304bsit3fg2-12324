        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                ?>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-grey-900">Services</h6>
                        </div>
                        <div class="card-body">
                ...
                elseif($do == 'Add')
                {
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-900">Add New Service</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="services.php?do=Add">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="service_price">Service Price(P)</label>
                                ...
                                <button type="submit" name="add_new_service" class="btn btn-success">Add service</button>
                ...
                elseif($do == "Edit")
                {
                    ...
                    if($service_id)
                    {
                        ...
                        if($count > 0)
                        {
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-gray-900">Edit Service</h6>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="services.php?do=Edit&service_id=<?php echo $service_id; ?>">
                                        ...
                                        <!-- SUBMIT BUTTON -->
                                        <button type="submit" name="edit_service_sbmt" class="btn btn-success">Save Edits</button>
                                    </form>
