...
?>
        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                if ($do == 'Manage') {
                               $stmt = $con->prepare("SELECT e.*, s.category_name 
                               FROM employees e 
                                LEFT JOIN service_categories s ON e.category_id = s.category_id");
                    $stmt->execute();
                    ...
                    ?>
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-grey-900">Employees</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Service Designation</th>
                ...
                elseif($do == 'Add')
                {
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-grey-900">Add New Employee</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="employees.php?do=Add">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="employee_category">Service Designation</label>
                                        <select class="form-control" name="employee_category">
                                            <?php
                                                // Fetch service categories from the database
                                                $categoryQuery = $con->prepare("SELECT * FROM service_categories");
                                                $categoryQuery->execute();
                                                $categories = $categoryQuery->fetchAll();

                                                // Display service categories as options in the dropdown
                                ...
                                <button type="submit" name="add_new_employee" class="btn btn-success">Add employee</button>
                            ...
                            <?php
                                ...
                                if(isset($_POST['add_new_employee']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_add_employee_form == 0)
                                {
                                    ...
                                    try
                                    {
                                        $stmt = $con->prepare("INSERT INTO employees (first_name, last_name, phone_number, email, category_id) VALUES (?, ?, ?, ?, ?)");
                                        $stmt->execute(array($employee_fname, $employee_lname, $employee_phone, $employee_email, $employee_category));
                ...
                elseif($do == 'Edit')
                {
                    ...
                    if($employee_id)
                    {
                        ...
                        if($count > 0)
                        {
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-grey-900">Edit Employee</h6>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="employees.php?do=Edit&employee_id=<?php echo $employee_id; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="employee_category">
                                                        <?php
                                                            ...
                                                            // Display service categories as options in the dropdown
                                                            foreach ($categories as $category) {
                                                                $selected = ($employee['category_id'] == $category['category_id']) ? 'selected' : '';
                                        ...
                                        <!-- SUBMIT BUTTON -->
                                        <button type="submit" name="edit_employee_sbmt" class="btn btn-success">
                                            Edit employee
                                        </button>
                                    </form>
                                    <?php
                                        ...
                                        if (isset($_POST['edit_employee_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_employee_form == 0) {
                                            ...
                                            $employee_category = $_POST['employee_category']; // Add this line to get the selected category
                                        
                                            try {
                                                $stmt = $con->prepare("UPDATE employees SET first_name = ?, last_name = ?, phone_number = ?, email = ?, category_id = ? WHERE employee_id = ?");
                                                $stmt->execute(array($employee_fname, $employee_lname, $employee_phone, $employee_email, $employee_category, $employee_id));
