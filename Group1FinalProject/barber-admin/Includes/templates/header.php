...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8">
	  	...
	  	<meta name="description" content="The Ambassador Barbershop Salon and Tatto Co. Web Based Appointment System">
	...
	<body id="page-top">
  		...
  		<div id="wrapper">
			...
			<!-- Sidebar -->
			<ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion"  id="accordionSidebar"style="padding: 0px !important;background: #222227!important">
		  		<!-- Sidebar - Brand -->
		  		<a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
					<div class="sidebar-brand-icon rotate-n-15">
					</div>
					<div class="sidebar-brand-text mx-3">The Ambassador Management</div>
		  		</a>
